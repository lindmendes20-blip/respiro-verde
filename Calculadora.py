...
with st.form(key='form_plantas'):
    ...
    horas_sol = st.number_input("Quantas horas de sol seu jardim recebe por dia?", value=0, min_value=0, max_value=24)
    tamanho_jardim = st.number_input("Qual é o tamanho de seu jardim em metros quadrados?", value=0, min_value=0, max_value=100)
